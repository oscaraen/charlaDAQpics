...
void configADC(){
    //función de configuración del convertidor análogo a Digital
    //1. puerto de entrada
    ...
    //4. reloj de operación
    ADCON0bits.ADCS = 2; //  reloj de conversión: Fosc / 32
    //6. formato del resultado
    ADFM = 1;
    //7. habilitar el módulo
    ADCON0bits.ADON = 1;    
...
void main(void) {
    ...
    while(1){
        ...
        sprintf(texto, "el valor es: %u\r\n", lecturaADC);//utilizar un potenciometro.
        enviarString(texto);
    }
